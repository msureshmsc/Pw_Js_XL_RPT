...
class HerokuAppPage{
    ...
    async compareFieldScreenshot(fieldName, actualFieldSS, expectedFieldSS) {
      ...
      // Compare width and height
       softExpect(actualImage.width).toBe(expectedImage.width, 'Width mismatch in image comparison');
       softExpect(actualImage.height).toBe(expectedImage.height, 'Height mismatch in image comparison');
      ...
      softExpect(numDiffPixels).toBe(0);
  }
